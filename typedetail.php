...
// 
if (isset($_GET['id'])) {
    $list = $productModel->getProductTypeByID($_GET['id']);
}
//
...
<body>
    ...
    <main class="main">
        ...
        <section class="product" style="padding: 100px 0 50px;">
            <div class="container">
                <div class="product__content" style="display: initial;">
                    <div class="product__content-box box">
                        ...
                        <div class="item">
                            ...
                            <div class="rating" style="display: flex; align-items: center;">
                                ...
                                <div class="like">
                                    <form action="typedetail.php?id=<?php echo $item['id_type'] ?>" method="post">
